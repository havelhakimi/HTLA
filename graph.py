...
class GraphLayer(nn.Module):
    def __init__(self, config, graph_type,label_refiner=0):
...
class GraphEncoder(nn.Module):
    def __init__(self, config, graph_type='GAT', layer=1, data_path=None, tokenizer='bert-base-uncased',label_refiner=0):
