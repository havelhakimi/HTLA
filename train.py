...
parser.add_argument('--trpmg', type=int, default=0, help='whether Trip Margin required or not')
parser.add_argument('--trp_pen', type=float, default=1.0, help='Penalty for Trip loss')
parser.add_argument('--mg_list', nargs='+', type=float, help='List of margins')
